...
source AS (
  ...
  SELECT
    ...
    TO_DATE(
      prep_ping_instance.raw_usage_data_payload:license_trial_ends_on::TEXT
...
prep_usage_ping_cte AS (
  ...
  LEFT JOIN dim_product_tier
    ON
      ...
      AND IFF(
        add_country_info_to_usage_ping.dim_instance_id = 'ea8bf810-1d6f-4a6a-b4fd-93e8cbd8b57f',
        'SaaS',
        'Self-Managed'
