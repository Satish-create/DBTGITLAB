...
Note: This model is filtered to metrics where time_frame = 7d (https://metrics.gitlab.com/?q=7d). Metrics that timed out are set to a value of -1.
...
Note: This model is filtered to metrics where time_frame = all (https://metrics.gitlab.com/?q=all). Metrics that timed out are set to a value of -1.
...
Use case: Model used to determine active seats and subscriptions reporting on any given metric, this model DOES NOT account for whether the metric was reported on that instances version at the time of the ping.
...
Use case: Model used to determine active seats and subscriptions reporting on any given metric, this model accounts for whether the metric was reported on that instances version at the time of the ping.
...
Use case: New dimension table to map metrics for service ping
